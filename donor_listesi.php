...
if ($result->rowCount() > 0) {
    echo "<h2>Donör Listesi</h2>";
    echo "<div class='table-container'>";
    echo "<table class='styled-table'>";
    echo "<thead><tr><th>Ad Soyad</th><th>Yaş</th><th>Cinsiyet</th><th>İletişim</th><th>Kan Grubu</th><th>Adres</th><th>E-posta</th></tr></thead>";
    echo "<tbody>";
    ...
    echo "<p>Kayıtlı donör bulunamadı.</p>";
}
